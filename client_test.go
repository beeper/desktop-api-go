...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Accounts.GetAccounts(context.Background())
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Accounts.GetAccounts(context.Background())
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Accounts.GetAccounts(cancelCtx)
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Accounts.GetAccounts(deadlineCtx)
		if err == nil {
