...
func TestAppE2eeRecoveryCodeMarkBackedUp(t *testing.T) {
	...
	_, err := client.App.E2ee.RecoveryCode.MarkBackedUp(context.TODO())
	if err != nil {
...
func TestAppE2eeRecoveryCodeVerify(t *testing.T) {
	...
	_, err := client.App.E2ee.RecoveryCode.Verify(context.TODO(), beeperdesktopapi.AppE2eeRecoveryCodeVerifyParams{
		RecoveryCode: "x",
	})
	if err != nil {
		var apierr *beeperdesktopapi.Error
