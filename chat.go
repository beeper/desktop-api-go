...
import (
	...
	"github.com/stainless-sdks/beeper-desktop-api-go/packages/pagination"
...
func (r *ChatService) Get(ctx context.Context, query ChatGetParams, opts ...option.RequestOption) (res *Chat, err error) {
	opts = append(r.Options[:], opts...)
	path := "v0/get-chat"
